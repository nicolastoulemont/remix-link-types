...
export function computeType(routesSegments: ParsedSegments) {
  ...
  return `// File generated by @nicolastoulemont/remix-link-types, do not modify manually \n //The RawRouteConfig type might include a root catch all type that will reduce the quality of the intellisense, use the RouteConfig type instead \n${rawRouteConfigType} \n ${routeConfigType}`
}
